import { forgotPasswordSVC, userTokenSVC, obtainTokenUserSVC, updatePasswordSVC } from '../services/forgotPassword.js';
...
export const changePasswordCTL = async (req, res) => {
    ...
    if (!userId) return res.status(204).send("User Not Found")
