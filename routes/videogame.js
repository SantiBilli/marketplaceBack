...
import {
  obtainVideogamesCTL,
  registerVideogamesCTL,
  obtainVideogamesDetailCTL,
  obtainVideogamesUploadsCTL,
  obtainVideogameUploadsDetailsCTL,
  editVideogameUploadCTL,
  deleteVideogameCTL,
} from '../controller/videogame.js';
...
videogameRouter.get(
  '/videogames/details/:videogameId',
  validateToken,
  obtainVideogamesDetailCTL,
  cookieSender
);
...
videogameRouter.get(
  '/videogames/uploads/details/:videogameId',
  validateToken,
  obtainVideogameUploadsDetailsCTL,
  cookieSender
);
